    ...
    *,
    ...
    vector_layers = {
        "vector_layers": [
            {
                "id": SOURCE_LAYER,
                "description": "NYC Trash Map schedules, one feature per stored block face",
                "minzoom": minzoom,
                "maxzoom": maxzoom,
                "fields": {
                    "id": "String",
    ...
    rows = [
        ("name", "NYC Trash Map Collection Streets"),
        ("description", "Pre-generated NYC Trash Map block-face vector tiles"),
        ("type", "overlay"),
        ("format", "pbf"),
        ("version", version),
        ("source_database_sha256", source_database_sha256),
